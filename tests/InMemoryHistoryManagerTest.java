...
public class InMemoryHistoryManagerTest {
    ...
    protected Task createTask() {
        return new Task("Задача 1", "Описание 1", Status.NEW, 9898, LocalDateTime.of(2023, 2, 1, 15, 00));
    }
...
// add, remove, getHistory
    ...
    void shouldRemoveTaskFromTheBeginningOfTheHistory() {
        ...
        Task task2 = new Task("Задача 2", "Описание 3", Status.NEW, 989898, LocalDateTime.of(2023, 2, 1, 15, 00));
        int newTaskId2 = generateId();
        task2.setId(newTaskId2);
        Task task3 = new Task("Задача 3", "Описание 3", Status.NEW, 989898, LocalDateTime.of(2023, 2, 1, 15, 00));
    ...
    void shouldReturnHistory() {
        ...
        int newTaskId1 = generateId();
        task1.setId(newTaskId1);
        Task task2 = new Task("Задача 1", "Описание 1", Status.NEW, 989898, LocalDateTime.of(2023, 2, 1, 15, 00));
        int newTaskId2 = generateId();
        task2.setId(newTaskId2);
        historyManager.addTask(task1);
        historyManager.addTask(task2);
